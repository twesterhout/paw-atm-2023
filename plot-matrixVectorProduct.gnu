...
set ylabel "Speedup over the fastest few-node run" offset 0.5,-1.5

set output "assets/speedup-matrixVectorProduct-big.pdf"

plot [4:256][0.9:64] \
    1 + (x - 4) / 4 ls 1 lw 3 lc rgb "#cc000000" dt (10, 14) notitle, \
    "data/processed/matrixVectorProduct_44.csv" @lines ls 1 lw 3 notitle, "" @points ls 1 pt 7 ps 0.7 lw 2 title "44 spins", "" @points_border ls 1 pt 6 lc "black" ps 0.7 lw 1 notitle, \
    (x >= 16? 1 + (x - 16) / 16 : 1/0) ls 1 lw 3 lc rgb "#cc000000" dt (10, 14) notitle, \
    "data/processed/matrixVectorProduct_46.csv" @lines ls 2 lw 3 notitle, "" @points ls 2 pt 9 ps 0.8 lw 2 title "46 spins", "" @points_border ls 2 pt 8 lc "black" ps 0.8 lw 1 notitle
